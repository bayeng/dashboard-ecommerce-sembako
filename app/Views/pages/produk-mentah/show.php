<form action="<?= site_url('produk-mentah/update/' . $kategori['id']); ?>" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="nama" name="nama" value="<?= $kategori['nama'] ?>" disabled required>
    </div>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="harga" name="harga" value="<?= $kategori['harga'] ?>" disabled required>
    </div>
    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="kuantiti" name="kuantiti" value="<?= $kategori['kuantiti'] ?>" disabled required>
        </div>

        <div class="form-group col-md-6">
            <label for="satuan_kuantiti">Satuan Kuantiti</label>
            <input type="text" class="form-control" id="satuan_kuantiti" name="satuan_kuantiti" value="<?= $kategori['satuan_kuantiti'] ?>" disabled required>
        </div>
    </div>
